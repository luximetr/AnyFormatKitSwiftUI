...
update_version('AnyFormatKitSwiftUI.podspec', podspec_version_line_start, podspec_version_line_end)


print("• updating README file\n")

spm_package_line_start = '    .package(url: "https://github.com/luximetr/AnyFormatKitSwiftUI.git", .upToNextMajor(from: "'
spm_package_line_end = '"))'

pod_line_start = "pod 'AnyFormatKitSwiftUI', '~> "
pod_line_end = "'"
...
update_version('AnyFormatKitSwiftUI.xcodeproj/project.pbxproj', xproj_version_line_start, xproj_version_line_end)
